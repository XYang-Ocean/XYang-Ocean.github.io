# Xiang Yang personal website

This is a static academic personal website inspired by a clean Hugo Blox / academic portfolio style.
...
- `experience.html`: appointments, education, fieldwork, teaching
- `publications.html`: publication list
- `photos.html`: gallery
- `cv.html`: embedded CV and downloads
